...
== But
Le projet Atelier vise à organiser et structurer mon activité de formateur et développeur.

Le projet Atelier est basé sur le logiciel link:https://gradle.org/[gradle] comme automate de taches.
