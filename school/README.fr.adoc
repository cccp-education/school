...
== But
Le projet bureau vise à organiser et structurer mon activité de formateur et développeur.

Le projet bureau est basé sur le logiciel link:https://gradle.org/[gradle] comme automate de taches.
