...
open class Setup(
    ...
    private val workspaceTypePanel: JPanel = JPanel().apply { border = createTitledBorder("Installation type") },
    ...
    private val separatedEntriesWorkspaceRadioButton: JRadioButton = JRadioButton("Separated folders").apply {
        isSelected = false
    },
